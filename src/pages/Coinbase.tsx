            ...
            <div className="flex items-center md:justify-between py-4">
              ...
              <div className="w-1/4 md:w-auto md:flex text-right">
                ...
                <div className="hidden md:block md:flex md:items-center ml-2">
                  ...
                  <div>
                    <svg className="fill-current text-white h-4 w-4 block opacity-50" xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 20 20">
                      <path
          ...
          <div className="container mx-auto px-4">
            <div className="md:flex">
              <div className="flex -mb-px mr-8">
                <a href="#"
                   className="no-underline text-white md:text-blue-600 flex items-center py-4 border-b border-blue-600">
              ...
              <div className="flex -mb-px mr-8">
                <a href="#"
                   className="no-underline text-white opacity-50 md:text-gray-600 md:opacity-100 flex items-center py-4 border-b border-transparent hover:opacity-100 md:hover:border-gray-600">
                  <svg className="h-6 w-6 fill-current mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path d="M8 7h10V5l4 3.5-4 3.5v-2H8V7zm-6 8.5L6 12v2h10v3H6v2l-4-3.5z" fill-rule="nonzero" />
                  </svg>
                  Buy/Sell
                </a>
              </div>
        ...
        <div className="bg-white border-t border-b sm:border-l sm:border-r sm:rounded shadow mb-6">
          <div className="border-b px-6">
            <div className="flex justify-between -mb-px">
              ...
              <div className="hidden lg:flex">
                <button type="button" className="appearance-none py-4 text-blue-600 border-b border-blue-600 mr-6">
                  Bitcoin &middot; CA$21,404.74
                </button>
                <button type="button"
                        className="appearance-none py-4 text-gray-600 border-b border-transparent hover:border-gray-600 mr-6">
                  Ethereum &middot; CA$884.80
                </button>
                <button type="button"
                        className="appearance-none py-4 text-gray-600 border-b border-transparent hover:border-gray-600">
                  Litecoin &middot; CA$358.24
                </button>
              </div>
              <div className="flex text-sm">
                <button type="button"
                        className="appearance-none py-4 text-gray-600 border-b border-transparent hover:border-gray-600 mr-3">
                  1M
                </button>
                <button type="button"
                        className="appearance-none py-4 text-gray-600 border-b border-transparent hover:border-gray-600 mr-3">
                ...
                <button type="button" className="appearance-none py-4 text-blue-600 border-b border-blue-600 mr-3">
                  1M
                </button>
                <button type="button"
                        className="appearance-none py-4 text-gray-600 border-b border-transparent hover:border-gray-600 mr-3">
          ...
          <div className="flex items-center px-6 lg:hidden">
            ...
            <div className="flex-shrink w-32 inline-block relative">
              <select className="block appearance-none w-full bg-white border border-gray-400 px-4 py-2 pr-8 rounded">
                <option>BTC</option>
                <option>ETH</option>
                <option>LTC</option>
              </select>
              <div className="pointer-events-none absolute pin-y pin-r flex items-center px-2 text-gray-500">
          ...
          <div className="hidden lg:flex">
            ...
            <div className="w-1/3 text-center py-8">
              <div className="border-r">
                <div className="text-gray-800 mb-2">
                  <span className="text-3xl align-top"><span className="text-green-500 align-top">+</span>CA$</span>
        ...
        <div className="flex flex-wrap -mx-4">
            ...
            <div
              ...
              <div className="border-b">
                <div className="flex justify-between px-6 -mb-px">
                  <h3 className="text-blue-600 py-4 font-normal text-lg">Your Portfolio</h3>
                  <div className="flex">
                    <button type="button"
                            className="appearance-none py-4 text-blue-600 border-b border-blue-600 mr-3">
                      List
                    </button>
                    <button type="button"
                            className="appearance-none py-4 text-gray-600 border-b border-transparent hover:border-gray-600">
              ...
              <div className="flex-grow flex px-6 py-6 text-gray-800 items-center border-b -mx-4">
                ...
                <div className="w-2/5 xl:w-1/4 px-4 flex items-center">
                  <div className="rounded-full bg-indigo inline-flex mr-3">
                    <svg className="fill-current text-white h-8 w-8 block" xmlns="http://www.w3.org/2000/svg"
                      ...
                      <g fill-rule="evenodd">
                        <path
                          d="M10.13 17.76c-.1-.15-.06-.2.09-.12l5.49 3.09c.15.08.4.08.56 0l5.58-3.08c.16-.08.2-.03.1.11L16.2 25.9c-.1.15-.28.15-.38 0l-5.7-8.13zm.04-2.03a.3.3 0 0 1-.13-.42l5.74-9.2c.1-.15.25-.15.34 0l5.77 9.19c.1.14.05.33-.12.41l-5.5 2.78a.73.73 0 0 1-.6 0l-5.5-2.76z"></path>
                      </g>
                    </svg>
                  </div>
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="bg-white border-t border-b sm:rounded sm:border shadow">
              <div className="border-b">
                <div className="flex justify-between px-6 -mb-px">
                  <h3 className="text-blue-600 py-4 font-normal text-lg">Recent Activity</h3>
                </div>
              </div>
              <div>
                <div className="text-center px-6 py-4">
                  <div className="py-8">
                    <div className="mb-4">
                      <svg className="inline-block fill-current text-gray-500 h-16 w-16" xmlns="http://www.w3.org/2000/svg"
                           viewBox="0 0 20 20">
                        <path
                    ...
                    <p className="text-2xl text-gray-800 font-medium mb-4">No buys or sells yet</p>
                    <p className="text-gray-500 max-w-xs mx-auto mb-6">You've successfully linked a payment method and can
                      start buying digital currency.</p>
                    <div>
                      <button type="button"
                              className="bg-blue-600 hover:bg-blue-600 text-white border border-blue-600 rounded px-6 py-4">Buy
                        now
                      </button>
                    </div>
                  </div>
        ...
        <div className="container mx-auto px-4">
          <div className="md:flex justify-between items-center text-sm">
            <div className="text-center md:text-left py-3 md:py-4 border-b md:border-b-0">
              <a href="#" className="no-underline text-gray-600 mr-4">Home</a>
              <a href="#" className="no-underline text-gray-600 mr-4">Careers</a>
              <a href="#" className="no-underline text-gray-600">Legal &amp; Privacy</a>
            </div>
            <div className="md:flex md:flex-row-reverse items-center py-4">
              <div className="text-center mb-4 md:mb-0 md:flex">
                <div className="w-48 inline-block relative mb-4 md:mb-0 md:mr-4">
                  <select
                    className="leading-tight block appearance-none w-full bg-white border border-gray-400 px-3 py-2 pr-8 rounded">
                ...
                <div>
                  <a href="#"
                     className="inline-block leading-tight bg-blue-600 border border-blue-600 hover:bg-blue-600 px-3 py-2 text-white no-underline rounded">Need
                    help?</a>
                </div>
              </div>
              <div className="text-gray-500 text-center md:mr-4">&copy; 2017 Cointoad</div>
            </div>
          </div>
        </div>
      </div>
